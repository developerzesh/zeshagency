...
export default function InteractiveGlobeCanvas() {
  ...
  return (
    <div className="relative w-full" style={{ aspectRatio: '1/1', maxHeight: '700px' }}>
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-center pointer-events-none">
        {hoveredOffice ? (
          <p className="font-lato text-xs tracking-[0.2em] uppercase text-signal">
            {hoveredOffice.city} · {hoveredOffice.type} ({hoveredOffice.team})
          </p>
        ) : (
          <p className="font-lato text-[10px] tracking-[0.25em] uppercase text-text-muted">
            Drag to rotate · Hover markers for office details
          </p>
        )}
      </div>
    </div>
