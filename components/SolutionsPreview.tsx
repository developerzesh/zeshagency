...
export default function SolutionsPreview() {
  return (
    <section id="solutions" className="relative py-16 md:py-48 border-t border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
          {solutions.map((s, i) => (
            <RevealText key={s.slug} delay={i * 0.08} duration={1.4}>
              <a href={`/services/${s.slug}`} className="group block py-10 md:py-48 px-0 border-b border-border md:even:pl-16 md:odd:pr-16">
