            ...
            <div className="flex flex-wrap items-center gap-6 md:gap-10">
              <MagneticButton strength={0.4}>
                <a href="https://calendar.app.google/Mp8HrgYK67yjuYA29" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4">
                  ...
                  <span className="font-lato text-sm font-medium text-ink">Get {data.name} Strategy Audit</span>
                </a>
              </MagneticButton>
              <MagneticButton strength={0.3}>
            ...
            <div className="mt-12 flex flex-wrap items-center gap-6 md:gap-10">
              <MagneticButton strength={0.4}>
                <a href="https://calendar.app.google/Mp8HrgYK67yjuYA29" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4">
                  ...
                  <span className="font-lato text-sm font-medium text-ink">Start with a Free Audit</span>
                </a>
              </MagneticButton>
              <MagneticButton strength={0.3}>
                <Link href="/case-studies" className="font-lato text-sm text-text-muted hover:text-ink transition-colors duration-500 sig-hover py-2">
