      ...
      {extra.visualExample && (() => {
        const platforms = [
          ...
          },
          {
            ...
            name: 'Grok',
            svg: (
              // No official Grok/xAI mark exists in Simple Icons at all. Your original
              // "X"-like path is a reasonable stand-in but isn't the real logo — for
              // an accurate one, pull from xAI's own press/brand kit if they publish one.
