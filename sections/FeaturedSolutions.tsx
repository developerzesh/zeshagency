    ...
    <section className="py-16 md:py-48 border-t border-border">
      <div className="max-w-[1200px] mx-auto px-4 md:px-16">
        <div className="text-center mb-20">
          ...
          <RevealText delay={0.1}><h2 className="font-syne text-4xl md:text-6xl lg:text-7xl font-800 tracking-[-0.03em]">Services<span className="text-signal">.</span></h2></RevealText>
